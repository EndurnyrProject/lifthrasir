...
pub fn spawn_unified_character(
    ...
    // Note: Sprite hierarchy should be spawned separately using the appropriate events
    // For now, we'll just return the character entity
    // TODO: Emit SpawnCharacterSpriteEvent using proper EventWriter
