...
impl From<crate::infrastructure::networking::protocols::ro_char::CharacterInfo> for CharacterInfo {
    fn from(net: crate::infrastructure::networking::protocols::ro_char::CharacterInfo) -> Self {
        Self {
            name: net.name,
            job_id: net.class,
