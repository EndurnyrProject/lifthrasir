...
// Representative RO hair-palette hues. Exact palette sampling is deferred to visual polish.
const HAIR_SWATCHES: [Color; 9] = [
    Color::srgb_u8(0xe6, 0xc9, 0x7a),
    Color::srgb_u8(0x9b, 0x6a, 0x42),
    Color::srgb_u8(0x55, 0x35, 0x25),
    Color::srgb_u8(0xd6, 0x68, 0x55),
    Color::srgb_u8(0x6f, 0x8f, 0xc9),
    Color::srgb_u8(0x79, 0xb8, 0x7a),
    Color::srgb_u8(0xb2, 0x7b, 0xd9),
    Color::srgb_u8(0xd7, 0xd5, 0xcc),
    Color::srgb_u8(0x32, 0x32, 0x38),
];
