...
fn fragment(
    ...
    var base_color = textureSample(water_texture, water_sampler, in.uv);

    // Mix the texture with a water tint (very low alpha for high transparency)
    //let water_tint = vec4<f32>(1.0, 1.0, 1.0, 0.15);
    ...
    base_color.a = mix(0.005, 0.25, fresnel);
