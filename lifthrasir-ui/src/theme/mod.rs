...
pub const GLASS: Color = Color::srgb(0.063, 0.086, 0.078);
pub const GLASS_2: Color = Color::srgb(0.086, 0.118, 0.106);
pub const FIELD: Color = Color::srgb(0.031, 0.047, 0.043);
